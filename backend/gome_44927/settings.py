"""
Django settings for gome_44927 project.
...
WSGI_APPLICATION = 'gome_44927.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "gome_44927 API",
    "DESCRIPTION": "API documentation for gome_44927 App",
    "VERSION": "v1",
}
